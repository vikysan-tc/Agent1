...
# Use local CRM server if CRM_SERVER_URL is set, otherwise use production
CRM_SERVER_URL = os.environ.get('CRM_SERVER_URL', 'https://desperate-bird-personal-viky-c10a64c7.koyeb.app/crmserver')
